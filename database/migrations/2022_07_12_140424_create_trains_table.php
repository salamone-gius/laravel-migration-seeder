...
class CreateTrainsTable extends Migration
{
    ...
    public function up()
    {
        ...
        // con comando terminale 'php artisan migrate' avvio la migration che crea le colonne della mia tabella
        ...
        // con comando terminale 'php artisan make:seeder NomeTabella(in Pascal Case)TableSeeder' creo un file seeder attraverso cui potrò popolare (seminare) la mia tabella
